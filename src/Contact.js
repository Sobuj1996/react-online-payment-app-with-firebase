...
const Contact = () => {
    ...
    const submitData =async(event) =>{
        ...
        if( firstName &&
            ...
            address &&
            message ){
        const res= fetch("https://reactfirebaseproject-900fb-default-rtdb.firebaseio.com/userDataRecords.json",
        {
        method : "POST",
        headers:{
                           ...
                           <div className="row">
                               <div className="contact-leftside col-12 col-lg-5">
                                   ...
                                   <p className="main-hero-pera">
                                    ...
                                    <figure>
                                        <img src="./img/hero1.jpg" className="img-fluid"/>
                                    </figure>
                               </div>
                                        ...
                                        <div className="col-12 ">
                                            ...
                                            <div class="form-check form-checkbox-style">
                                                <input class="form-check-input"
                                                 ...
                                                 />
                                                <label class="form-check-label" className="main-hero-pera">
